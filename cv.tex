...
\definecolor{LINKS_COLOR}{HTML}{AA4F4F}
\definecolor{TITLE_LINE_COLOR}{HTML}{5088AB}
% footer
\thispagestyle{fancy}
\fancyhf{}
...
\hypersetup{
    colorlinks=true,
    linkcolor=LINKS_COLOR,
    filecolor=LINKS_COLOR,      
    urlcolor=LINKS_COLOR,
    pdftitle={},
...
{}
{0pt}
{}[\color{TITLE_LINE_COLOR}\titlerule]
% the begin
\begin{document}
